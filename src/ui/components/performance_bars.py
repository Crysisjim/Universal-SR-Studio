...
class PerformanceBars(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.labels = [
            "Netteté (Sharpness)", "Texture/Détail", "Fidélité (PSNR)", 
            "Vitesse (Inference)", "Légèreté VRAM", 
            "Efficacité Anime", "Efficacité Réaliste"
        ]
        ...
        self.lbl_legend = ctk.CTkLabel(self, text="Calcul dynamique basé sur tous les paramètres.", font=("Arial", 9, "italic"), text_color="gray70")
