...
def aether_pro(scale: int, mlp_ratio: float = 1.75, **kwargs) -> AetherNet:
    """
    ...
    Args:
        scale: Super-resolution scale factor
        mlp_ratio: FFN expansion ratio (default: 1.75 for pro preset)
        **kwargs: Additional keyword arguments for AetherNet
    """
    return AetherNet(
        embed_dim=192,
...
def aether_extreme(scale: int, mlp_ratio: float = 2.0, **kwargs) -> AetherNet:
    """
    ...
    Args:
        scale: Super-resolution scale factor
        mlp_ratio: FFN expansion ratio (default: 2.0 for extreme preset)
        **kwargs: Additional keyword arguments for AetherNet
    """
    return AetherNet(
        embed_dim=256,
